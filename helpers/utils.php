...
function isDistributionListId($str)
{
	$syntaxe = '#[a-f0-9]{8}\-[a-f0-9]{4}\-[a-f0-9]{4}\-[a-f0-9]{4}\-[a-f0-9]{12}#';
	if(preg_match($syntaxe,$str))
		return true;
...
function isDistributionListName($str)
{
	$syntaxe = '#([0-9a-zA-Z][-\w]*[0-9a-zA-Z]\.)+[a-zA-Z]{2,9}#';
	if(preg_match($syntaxe,$str))
		return true;
...
function getDistributionListType($str)
{
	$outputType = null;
	if(isDistributionListName($str))
		$outputType = "name";
	else if (isDistributionListId($str))
		$outputType = "id";
	else
		echo "Unknown DistributionListType";
